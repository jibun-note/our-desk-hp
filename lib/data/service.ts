...
export const HERO = {
	...
	headline: "「頼んでよかった」が\n続く仕組み",
	sub: "請求・日程調整・書類管理・顧客対応などのバックオフィス業務を、分単位から依頼できます。\n小さく始めて、信頼できる人材と長く働ける関係を育てていけます。",
...
export const PAIN_ITEMS: PainItem[] = [
	{
		...
		body: "請求、日程調整、書類管理、案内連絡。やるべきことは増えていくのに、本来集中したい業務に時間を使えなくなっている。",
	},
	{
		title: "誰かに任せたいが、正社員採用はまだ重い",
		body: "任せたい仕事はあるものの、採用コストや教育コスト、ミスマッチのリスクを考えると、今すぐ雇用には踏み切りにくい。",
	},
	{
		title: "単発の外注ではなく、継続的に理解してくれる人がほしい",
		body: "その場しのぎではなく、少しずつ業務を理解し、継続的に支えてくれる存在がいると助かる。そんな悩みを抱える企業は少なくありません。",
	},
];
...
export const HOW_ITEMS: HowItem[] = [
	{
		...
		body: "「請求書を送ってほしい」「日程調整だけ任せたい」そんな小さな依頼から始められます。固定費を増やさず、必要な業務を必要な分だけ頼めます。",
	},
	{
		title: "定型業務から始めて、少しずつ任せる範囲を広げられる",
		body: "まずは毎日・毎週発生する定型業務からスタートし、慣れてきたら資料作成や採用支援などへ広げることもできます。",
	},
	{
		title: "OurDeskが間に入り、進めやすい形を整える",
		body: "業務内容の整理、進め方のすり合わせ、必要に応じたスタッフ提案まで、OurDeskが伴走しながら進行します。丸投げにならず、安心して任せられます。",
	},
	{
		title: "相性を見ながら、将来的な正式採用も相談できる",
		body: "実際の仕事を通して業務理解や信頼関係を育てられるため、採用前に相性を確かめやすいのも特徴です。双方の希望が合えば、正式な雇用もご相談いただけます。",
	},
];
...
export const PRICING_HEAD = {
	eyebrow: "料金",
	headline: "業務の種類に合わせた\nシンプルな時間単価",
	sub: "サービスは分単位でご利用可能。最低利用時間の縛りはありません。ご相談時に、依頼内容に応じたランクと想定稼働時間の目安をご案内します。",
...
export const PROCESS_STEPS: ProcessStepItem[] = [
	{
		num: "01",
		title: "無料相談・ヒアリング",
		body: "何を任せられるかわからない方も大歓迎。現状の業務やお困りごとを伺い、どこから任せられそうかを一緒に整理します。",
		active: true,
	},
	{
		num: "02",
		title: "スタッフのご提案",
		body: "業務内容に合ったスタッフをご提案します。必要に応じて事前面談やプロフィール共有も可能です。",
	},
	{
		num: "03",
		title: "契約・業務開始",
		body: "基本契約や必要に応じたNDA、連絡ツール、報告ルールを確認したうえで、稼働を開始します。",
	},
	{
		num: "04",
		title: "稼働・確認",
		body: "実施内容・稼働時間・請求はBackDesk上でいつでも確認できます。任せっぱなしにならず、状況を見ながら進められます。",
	},
	{
		num: "05",
		title: "継続・スケールアップ",
		body: "信頼関係や業務理解が深まったら、依頼範囲を広げることも可能です。相性が合えば、将来的な正式採用もご相談いただけます。",
	},
];
...
export const CASE_STUDIES: CaseStudyItem[] = [
	{
		...
		tasks: ["請求書の作成・送付・格納", "前日リマインド／案内連絡", "月次スケジュール配信"],
		result: "定型的な事務作業を移管できたことで、本業に集中する時間を確保。稼働内容もBackDesk上で確認でき、安心して継続利用につながっている。",
		image: "/images/service/telework01.jpeg",
		imageAlt: "IT系・一人法人",
	},
	{
		...
		tasks: ["返信対応、案内文作成、投稿代行", "出欠確認、日程調整、スケジュール配信"],
		result: "対応品質が安定し、返信遅延も減少。まずは一部業務から任せ、運営が整ったことで、将来的な採用も視野に入れられるようになった。",
		image: "/images/service/telework02.jpeg",
...
export const FAQ_ITEMS: FaqItem[] = [
	{
		q: "最低利用時間はありますか？",
		a: "ありません。サービスは分単位でご利用可能です。「請求書を1通送ってほしい」といった小さな依頼から始めていただけます。",
	},
	{
		q: "料金はどのように決まりますか？",
		a: "業務の種類によってランクA（2,500円/h）・ランクB（2,300円/h）・ランクC（2,200円/h）の3段階です。ご相談時に、依頼内容に応じたランクと想定稼働時間の目安をご案内します。",
	},
	{
		q: "どんな業務を依頼できますか？",
	...
	},
	{
		...
		a: "できます。最低利用時間の縛りがないため、業務量に合わせて柔軟に調整できます。小さく始めて、慣れてきたら範囲を広げる使い方も可能です。",
	},
	{
		q: "将来的に正式採用することはできますか？",
		a: "はい。一緒に仕事をする中で双方の希望が合えば、正式な雇用に切り替えることも可能です。実際の仕事を通して相性を確かめられる点も特徴です。",
	},
	{
		q: "業務の進捗や請求は確認できますか？",
	...
	{
		q: "機密情報を含む業務も依頼できますか？",
		a: "業務内容に応じて、契約や取り扱いルールを整理したうえで進めます。まずはご相談ください。",
	},
	{
		q: "マニュアルがなくても依頼できますか？",
		a: "はい。現状のやり方をヒアリングしながら、必要に応じて整理して進めます。最初から完璧なマニュアルがなくても問題ありません。",
	},
	{
		q: "どのような連絡ツールに対応していますか？",
		a: "チャットツールやオンラインミーティングを中心に、運用しやすい方法をご相談のうえ決定します。",
	},
];
...
export const CTA = {
	...
	sub: "まだ具体的でなくても大丈夫です。現状をお聞きしながら、BackDeskでお手伝いできることをご提案します。",
	button: "まずは相談してみる",
} as const;

// ── Images ────────────────────────────────────────────────────────────────
export const IMG = {
	hero: "/images/about-us/04.jpeg",
	pain: "/images/recruit/intro.jpeg",
	process: "/images/service/process.jpeg",
	faq: "/images/service/faq.jpeg",
