        ...
        <section className="wave-divider relative z-[5] bg-white py-20 md:py-32" aria-label="3つの働き方">
            <div className="max-w-6xl mx-auto px-4 md:px-6 relative z-10">
                <div className="text-center mb-12 md:mb-20">
                    <h2 className="text-2xl md:text-4xl font-bold text-gray-800 text-balance">
                        3つの働き方
                    </h2>
                    <div className="flex justify-center my-4">
                        <HandwrittenLine variant={2} color="#F08300" width={120} align="center" />
                    </div>
                    <p className="text-base md:text-lg text-gray-600 text-pretty leading-relaxed">あなたのライフスタイルに合わせて選べます</p>
                </div>
                <div className="grid md:grid-cols-3 gap-6 md:gap-8">
                    {workStyles.map((item) => (
                        ...
                        >
                            ...
                            <p className="text-sm text-orange-600 mb-4 md:mb-6 font-medium">
                                {item.label}
                            </p>
                            ...
                            {item.note && (
                                <p className="text-sm text-gray-500 mt-2 leading-relaxed text-pretty">{item.note}</p>
                            )}
                        </div>
                    ))}
                </div>
