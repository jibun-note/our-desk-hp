    ...
    return (
        <section className="relative py-20 md:py-32 px-4 md:px-6" aria-label="3つの特徴">
            ...
            <BlobDecoration
                ...
                className="bottom-[10vw] md:bottom-[-10vw] right-[-10vw] w-[72vw] h-[72vw] md:w-[33vw] md:h-[33vw] max-md:top-[-8vw] max-md:bottom-auto max-md:right-[-28vw]"
            />
                ...
                <div className="grid md:grid-cols-3 gap-10 md:gap-16">
                    {features.map((item) => (
                        <div key={item.num}>
                            ...
                            <h3 className="text-xl md:text-2xl font-medium mb-4 text-gray-900 text-balance">{item.title}</h3>
