...
import type { ServiceCategoryItem } from '@/lib/data/service'
...
export default function ServiceServicesSection({ head, cards }: Props) {
  return (
    <section id="services" className="bg-white py-20 md:py-28 relative" aria-label="OurDeskがサポートできること">
